...
const jobsShouldBeInterruptible = {
  ...
  rule: (key, obj, depth, resolver, node, doc) => {
    ...
    if (depth === 0 && key === 'default') {
      ...
      jobsShouldBeInterruptible.defaultNode = node;
      return;
    }
      ...
      if (!Object.hasOwn(obj, 'interruptible')) {
        ...
        return {
          ...
          fix: () => {
            ...
            if (!jobsShouldBeInterruptible.defaultNode) {
              const defaultNode = doc.createPair('default', {
                interruptible: true,
              });
              ...
              jobsShouldBeInterruptible.defaultNode.value.items.unshift(
